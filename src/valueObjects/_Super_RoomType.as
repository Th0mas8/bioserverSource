 ...
 * of this value object you may modify the generated sub-class of this class - RoomType.as.
 */
...
[ExcludeClass]
public class _Super_RoomType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _RoomTypeEntityMetadata;
    ...
    private var _internal_roomtypes_id : Number;
    ...
    public function _Super_RoomType()
    {
        _model = new _RoomTypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get roomtypes_id() : Number
    {
        return _internal_roomtypes_id;
    }
    ...
    public function set roomtypes_id(value:Number) : void
    {
        var oldValue:Number = _internal_roomtypes_id;
        if (oldValue !== value)
        {
            _internal_roomtypes_id = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "roomtypes_id", oldValue, _internal_roomtypes_id));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _RoomTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _RoomTypeEntityMetadata) : void
    {
        var oldValue : _RoomTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
