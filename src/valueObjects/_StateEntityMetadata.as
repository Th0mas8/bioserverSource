...
[ExcludeClass]
internal class _StateEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("code", "deleted", "name", "shortName", "starttime", "state_id", "updatetime");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("code", "deleted", "name", "shortName", "starttime", "state_id", "updatetime");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("code", "deleted", "name", "shortName", "starttime", "state_id", "updatetime");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("code", "deleted", "name", "shortName", "starttime", "state_id", "updatetime");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "State";
    ...
    model_internal var _instance:_Super_State;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _StateEntityMetadata(value : _Super_State)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["state_id"] = new Array();
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity State");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity State");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity State");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isState_idAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get state_idStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
