package org.igorcosta.hacks
{
	...
	public class SWF
	{
		//public var src:ByteArray = new ByteArray();
		public function SWF()
		{
		}
		...
		public static function readCompilationDate(tmp:ByteArray,serialNumber: ByteArray = null): Date
		{
			...
			if (serialNumber == null)
				serialNumber = readSerialNumber(tmp);
		...
		public static function readSerialNumber(tmp:ByteArray): ByteArray
		{
			const TAG_SERIAL_NUMBER: uint = 0x29;
			return findAndReadTagBody(tmp,TAG_SERIAL_NUMBER);
		}
		
		///////////////////////////////////////////////////////////////////////////
		// Returns the tag body if it is possible
		public static function findAndReadTagBody(tmp:ByteArray,theTagCode: uint): ByteArray
		{
			// getting direst access to unpacked SWF file
			const src: ByteArray = tmp;
