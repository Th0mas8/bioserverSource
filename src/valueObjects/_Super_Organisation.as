 ...
 * of this value object you may modify the generated sub-class of this class - Organisation.as.
 */
...
[ExcludeClass]
public class _Super_Organisation extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _OrganisationEntityMetadata;
    ...
    private var _internal_organisation_id : Number;
    private var _internal_starttime : Date;
    private var _internal_updatedby : Number;
    ...
    public function _Super_Organisation()
    {
        _model = new _OrganisationEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get organisation_id() : Number
    {
        return _internal_organisation_id;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get updatedby() : Number
    {
    ...
    public function set organisation_id(value:Number) : void
    {
        var oldValue:Number = _internal_organisation_id;
        if (oldValue !== value)
        {
            _internal_organisation_id = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "organisation_id", oldValue, _internal_organisation_id));
        }
    }
    ...
    public function set updatedby(value:Number) : void
    {
        var oldValue:Number = _internal_updatedby;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OrganisationEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OrganisationEntityMetadata) : void
    {
        var oldValue : _OrganisationEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
