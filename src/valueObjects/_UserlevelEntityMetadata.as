...
[ExcludeClass]
internal class _UserlevelEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("deleted", "description", "level_id", "starttime", "statuscode", "updatetime");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("deleted", "description", "level_id", "starttime", "statuscode", "updatetime");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("deleted", "description", "level_id", "starttime", "statuscode", "updatetime");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("deleted", "description", "level_id", "starttime", "statuscode", "updatetime");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Userlevel";
    ...
    model_internal var _instance:_Super_Userlevel;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _UserlevelEntityMetadata(value : _Super_Userlevel)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Userlevel");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Userlevel");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Userlevel");
        }
